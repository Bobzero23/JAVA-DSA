...
import LinkedLists.singly_LinkedList_demo.Node;

public class LinkedList {

    /*Their types are node because both of them will be pointed to the node*/
    public LinkedLists.singly_LinkedList_demo.Node head;
    public LinkedLists.singly_LinkedList_demo.Node tail;
    public int size;


    /*method to create a singly linked list*/
    public LinkedLists.singly_LinkedList_demo.Node create_singly_linkedList(int node_value) {
        head = new LinkedLists.singly_LinkedList_demo.Node();
        LinkedLists.singly_LinkedList_demo.Node node = new LinkedLists.singly_LinkedList_demo.Node();
        node.next = null;
    ...
    public void insert_into_linked_list(int node_value, int location) {
        ...
        if(head == null) {
            ...
            LinkedLists.singly_LinkedList_demo.Node temp_node = head;
            int index = 0;
            while(index < location - 1) {
                temp_node = temp_node.next;
                index++;
            }
            LinkedLists.singly_LinkedList_demo.Node next_node = temp_node.next;
            temp_node.next = node;
            node.next = next_node;
        }
        size++;
